...
assert.match(economy, /CREATE TRIGGER gn_e9_balance_change/, 'E9 automatic balance guard missing')
assert.match(economy, /CREATE TRIGGER gn_e9_enrich_from_global_ledger/, 'E9 semantic enrichment trigger missing')
assert.match(economy, /CREATE TRIGGER gn_e9_account_opening/, 'E9 opening/import audit missing')
assert.match(economy, /CREATE TRIGGER gn_e9_account_closing/, 'E9 closing/merge audit missing')
