...
assert.match(subbotPage, /sectionIds: SubbotSection\[\] = \['overview', 'platforms', 'providers', 'groups', 'audit', 'diagnostics', 'account'\]/, 'Subbot diagnostics route must be explicitly allowed')
