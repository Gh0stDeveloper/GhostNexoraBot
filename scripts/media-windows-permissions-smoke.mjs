...
const humanReactionsCommand = read('apps/bot/src/commands/human-reactions.ts')
...
assert.match(humanReactionsCommand, /name: 'reaccioneshumanas'/, 'Human reactions control command missing')
