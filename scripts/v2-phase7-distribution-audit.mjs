...
console.log('[V2 DISTRIBUTION AUDIT] OK — VPS builds use the validated Android SDK, resumable same-SHA phases, explicit Windows signer trust, and root-only persistent signing material.')
