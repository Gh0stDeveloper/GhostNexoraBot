...
assert.doesNotMatch(`${catalogApi}\n${downloadApi}`, /spawn|exec|gradle|cargo|keytool|gpg|osslsigncode|npm run tauri/i, 'HTTP release routes must never build or sign artifacts')
