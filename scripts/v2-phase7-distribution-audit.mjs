...
console.log('[V2 DISTRIBUTION AUDIT] OK — official download Web is read-only, VPS builds use the CI-validated Android SDK package, and persistent signing material remains root-only outside public artifacts/SQLite.')