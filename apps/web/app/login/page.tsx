    ...
    <section className="ops-panel mx-auto w-full max-w-md overflow-hidden">
      <div className="p-7 md:p-9">
        ...
        <div className="mt-10 text-center">
          ...
          <h1 className="mt-2 text-3xl font-black tracking-[-.04em] text-white">{mfa ? pt('loginMfaTitle') : pt('loginAutoTitle')}</h1>
          <p className="mt-2 text-sm text-zinc-500">{mfa ? pt('loginMfaText') : pt('loginAutoText')}</p>
        </div>
