 ...
 *
 * Se conserva el comportamiento de V1: cuando la precarga funciona Baileys
 * recibe un Buffer; cuando falla una URL/ruta se delega a `{ url }` como
 * fallback. La ubicación cambia a la capa WhatsApp, no el protocolo.
 */
